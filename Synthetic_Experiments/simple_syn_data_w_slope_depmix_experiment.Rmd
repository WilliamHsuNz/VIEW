...
```{r}
f14mod
save(f14mod, ascii=FALSE, file='simple_syn_combined_w_slope_14states_2500inds') 
```

```{r}
# set up test data
#test <- view_ch_phh[280001:560000, ]
write.csv(test, file="simple_syn_combined_w_slope_test_data_2500inds.csv")
```
...
```{r}
write.csv(population_df, file="simple_syn_combined_w_slope_depmix_forecast__train2500inds_1000inds.csv")
```
